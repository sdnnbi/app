...
class ARP_PROXY_10(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_0.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(ARP_PROXY_10, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
        self.arp_table = {}
        self.sw = {}
    ...
    def _packet_in_handler(self, ev):
        ...
        eth1 = pkt.get_protocol(ethernet.ethernet)
        print("equal: ", eth==eth1)
    ...
    def arp_handler(self, header_list, datapath, in_port, msg_buffer_id):
        ...
        print("ETHERNET_MULTICAST-->", ETHERNET_MULTICAST)
        print("ARP-->", ARP)
